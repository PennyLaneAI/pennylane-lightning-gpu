...
# -*- coding: utf-8 -*-
#
# PennyLane-Lightning-GPU documentation build configuration file.
#
...
MOCK_MODULES = ["pennylane_lightning_gpu.lightning_gpu_qubit_ops", "ctypes.util"]
...
exhale_args = {
    ...
    "afterTitleDescription": inspect.cleandoc(
        """
        The Pennylane-Lightning-GPU C++ API is intended to be called from Python through Pybind11. Direct use of the C++ API is currently unsupported and is provided for reference only.
        """
    ),
}
...
project = "PennyLane-Lightning-GPU"
...
release = pennylane_lightning_gpu.__version__
...
html_theme_options = {
    ...
    "navbar_right_links": [
        ...
        {
            "name": "GitHub",
            "href": "https://github.com/PennyLaneAI/pennylane-lightning-gpu",
            "icon": "fab fa-github",
        }
    ],
