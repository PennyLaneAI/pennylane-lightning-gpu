...
if CPP_BINARY_AVAILABLE:
    ...
    class LightningGPU(QubitDevice):
        ...
        Args:
            ...
            mpi_buf_size(int): GPU memory size (in mebibytes) for MPI operation. By default (`mpi_buf_size=0`), the GPU memory allocated for MPI operations will be the same of size of the local state vector, with a limit of 64 MB.
