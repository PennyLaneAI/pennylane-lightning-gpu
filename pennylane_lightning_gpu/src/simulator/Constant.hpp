...
namespace Pennylane::CUDA::cuGates::Constant {
/**
 * @brief Constant gate names.
 */
[[maybe_unused]] constexpr std::array const_gate_names{
        std::string_view{"Identity"}, 
        std::string_view{"PauliX"}, 
        std::string_view{"PauliY"}, 
        std::string_view{"PauliZ"}, 
        std::string_view{"Hadamard"}, 
        std::string_view{"T"},
        std::string_view{"S"},
        std::string_view{"CNOT"},
        std::string_view{"SWAP"},
        std::string_view{"CZ"},
        std::string_view{"CSWAP"},
        std::string_view{"Toffoli"}};

/**
 * @brief The mapping of named gates to amount of 
 * control wires they have.
 */
[[maybe_unused]] const std::array cmap_gates{
